"""Deterministic theme clustering helpers for bundled paper-search-pro runtime.
...
THEME_CONCEPT_ALIASES_PATH = Path(__file__).resolve().parent.parent / "assets" / "theme_concept_aliases.json"
